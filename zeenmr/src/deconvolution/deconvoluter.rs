...
///
/// ```
/// use zeenmr::deconvolution::{Deconvoluter, Deconvolution, Lorentzian};
...
impl Deconvoluter {
    ...
    ///
    /// ```
    /// use zeenmr::deconvolution::{Deconvoluter, SmoothingSettings};
    ///
    /// let deconvoluter = Deconvoluter::default();
    ///
    ...
    /// use zeenmr::deconvolution::{Deconvoluter, ScoringMethod, SelectionSettings};
    ///
    /// let deconvoluter = Deconvoluter::default();
    ///
    ...
    ///
    /// ```
    /// use zeenmr::deconvolution::{Deconvoluter, FittingSettings};
    ///
    /// let deconvoluter = Deconvoluter::default();
    ///
