...
/// A specialized [`Result`] type for the ZeeNMR library.
///
/// This type alias is used to avoid writing out `Result<T, zeenmr::Error>`
/// directly, and is broadly used across the library.
pub type Result<T> = std::result::Result<T, Error>;

/// Errors encountered by the ZeeNMR library.
///
