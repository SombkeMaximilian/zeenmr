...
def main():
    signal = (-2.2, 11.8)
    blood = zn.Spectrum.read_bruker("../../data/bruker/blood/blood_01", 10, 10, signal)
    ...
    deconvolution_json = zn.Deconvolution.read_json("blood_deconvolution.json")
    deconvolution.write_bin("blood_deconvolution.bin")
    deconvolution_bin = zn.Deconvolution.read_bin("blood_deconvolution.bin")
