...
impl Aligner {
    ...
    ///
    /// ```
    /// use metabodecon::alignment::{Aligner, AlignmentStrategy};
    ///
    /// let aligner = Aligner::default();
    ///
    ...
    /// use metabodecon::alignment::{Aligner, FilteringSettings, SimilarityMetric};
    ///
    /// let aligner = Aligner::default();
    ///
    ...
    ///
    /// ```
    /// use metabodecon::alignment::{Aligner, SolvingSettings};
    ///
    /// let aligner = Aligner::default();
    ///
